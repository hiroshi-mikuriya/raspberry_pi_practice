...
AQUA = [WRITE, ADDR, ([0xFF] * 8 + [0] * 4) * 8].flatten.pack('c*').freeze
YELLOW = [WRITE, ADDR, ([0] * 4 + [0xFF] * 8) * 8].flatten.pack('c*').freeze
PINK = [WRITE, ADDR, ([0xFF] * 4 + [0] * 4 + [0xFF] * 4) * 8].flatten.pack('c*').freeze
