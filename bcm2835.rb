...
module BCM
  ...
  extern 'unsigned int bcm2835_gpio_eds_multi(unsigned int mask)'
  extern 'void bcm2835_gpio_set_eds(unsigned char pin)'
  extern 'void bcm2835_gpio_set_eds_multi(unsigned int mask)'
  ...
  extern 'void bcm2835_delayMicroseconds (unsigned long micros)'
  ...
  extern 'void bcm2835_spi_writenb(const char* buf, unsigned int len)'
  extern 'void bcm2835_spi_write(unsigned short data)'
  extern 'int bcm2835_aux_spi_begin(void)'
  extern 'void bcm2835_aux_spi_end(void)'
  extern 'void bcm2835_aux_spi_setClockDivider(unsigned short)'
  extern 'unsigned short bcm2835_aux_spi_CalcClockDivider(unsigned int speed_hz)'
  extern 'void bcm2835_aux_spi_write(unsigned short)'
  extern 'void bcm2835_aux_spi_writenb(const char *buf, unsigned int len)'
  extern 'void bcm2835_aux_spi_transfern(char *, unsigned int)'
  extern 'void bcm2835_aux_spi_transfernb(const char *, char *, unsigned int)'
  ...
  extern 'unsigned long bcm2835_st_read(void)'
  extern 'void bcm2835_st_delay(unsigned long offset_micros, unsigned long micros)'
